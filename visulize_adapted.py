...
# Open hdf5 file
dataset = "imgint_testset_v2.hdf5"
dataset = h5py.File(dataset,'r')

testset = "imgint_testset_v2.hdf5"
...
false_image.save('false_img_original.png')
